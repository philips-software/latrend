...
In this example however, there is no use for such data processing, but to illustrate the function signature, we define an empty function that returns `NULL`, which is an accepted output for the function.
```{r}
...
setMethod('fit', signature('clMethodSimpleGBTM'), function(method, data, envir, verbose, ...) {
  mod = lcmm::lcmm(fixed = method$formula,
