...
#' @description Returns a random index, weighted by the element magnitudes. This function is intended to be used as an optional strategy for \link{clusterAssignments,clModel-method}, resulting in randomly sampled cluster membership.
