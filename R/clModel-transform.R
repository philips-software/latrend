...
setMethod('transformFitted', signature('NULL', 'clModel'), function(pred, model, clusters) {
  NULL
})

setMethod('transformFitted', signature('matrix', 'clModel'), function(pred, model, clusters) {
...
setMethod('transformFitted', signature('list', 'clModel'), function(pred, model, clusters) {
...
setMethod('transformPredict', signature('data.frame', 'clModel'), function(pred, model, newdata) {
  assert_that(is.newdata(newdata),
              !is.null(newdata))
